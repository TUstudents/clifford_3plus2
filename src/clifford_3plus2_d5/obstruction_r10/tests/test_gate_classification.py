...
from clifford_3plus2_d5.obstruction_r10.sm.classification import (
    NamedRealGate,
...
from clifford_3plus2_d5.obstruction_r10.sm.embedding import complex_projector_3, matrix_unit
