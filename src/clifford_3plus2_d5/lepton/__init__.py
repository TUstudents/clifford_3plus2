...
from clifford_3plus2_d5.lepton.clifford_patisalam import (
    ...
    cl06_gamma_matrices,
    cl06_relations_pass,
    independent_basis_for_generators,
    ...
    patisalam_complex_structure_full,
