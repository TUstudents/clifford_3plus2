...
def spacetime_simulation_summary(result: SpacetimeSimulationResult) -> dict[str, Any]:
    ...
    return {
        ...
        "force_method": result.config.force_method,
        "force_chunk_size": result.config.force_chunk_size,
        "gauss_projection_steps": result.config.gauss_projection_steps,
        "gauss_projection_step_size": result.config.gauss_projection_step_size,
