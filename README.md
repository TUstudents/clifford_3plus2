...
| [`qca_smv0`](src/clifford_3plus2_d5/qca_smv0/) | **Stage 27 PASS** | Focused simulator sidecar for the next Standard-Model QCA prototype. Stage 1 implements the free BCC Weyl/Dirac bulk walk in JAX. Stage 2 adds a local 32-component SM carrier and static `SU(3)_c x SU(2)_L x U(1)_Y` BCC gauge links. Stage 3 adds pure dynamic SM gauge fields with link momenta, Wilson force, Hamiltonian leapfrog, electric-divergence/Gauss diagnostics, weak-field Yang-Mills audits, no-backreaction spectator fermion transport, and JIT compatibility. Stage 4 adds a local Higgs doublet and exact site-local Higgs/Yukawa collision with SM door checks, chirality flip, massive dispersion, and JIT compatibility. Stage 5 adds finite hidden recirculation paths for FN Yukawa matrices, with `lambda^n` generated by local beam-splitter chains and CKM-like left-frame mismatch read from the generated matrices. Stage 6 adds center-holonomy CP coefficients. Stage 7 embeds the generated three-family Yukawa matrices into an exact local Higgs/Yukawa collision on `(4,32,3)` fermion states. Stage 8 adds dynamic Higgs-field evolution. Stage 9 adds Higgs gauge-current backreaction on electroweak link momenta. Stage 10 adds local Yukawa fermion backreaction into Higgs momenta. Stage 11 adds the BCC streaming fermion current on SM gauge links. Stage 12 combines Wilson, embedded Higgs, and fermion streaming gauge sources into one sourced SM link tick. Stage 13 lifts the BCC streaming current/charge/Gauss diagnostics to the family carrier. Stage 14 lifts the sourced gauge tick to the family carrier. Stage 15 merges the three-family Yukawa/Higgs source and exact local family Yukawa collision into that family-sourced tick. Stage 16 audits the transport-vs-Yukawa-door gauge convention split. Stage 17 implements the exact antiunitary singlet bridge. Stage 18 applies that bridge to finite BCC family transport. Stage 19 lifts the family streaming current/charge/Gauss and momentum kick onto the physical-right bridged carrier. Stage 20 uses that current in a physical-right sourced gauge tick. Stage 21 merges the local family Yukawa production source into the physical-right sourced tick. Stage 22 adds sparse recorded rollout of that physical-right production tick through the shared `sim.runner` loop/scan interface. Stage 23 monitors the existing physical-right sourced Gauss diagnostic over the production rollout with an exact zero-vacuum control. Stage 24 records gauge, Higgs, streaming, and Yukawa energy components over the production rollout. Stage 25 repairs and audits the physical-right production force-energy pairing with variational finite-difference checks. Stage 26 records that timestep halving does not improve monitored production-energy drift for the current hybrid tick. Stage 27 adds the physical-right transport adjoint and proves the frozen production fermion substage is invertible, while recording that a negative-timestep full production tick is not a full inverse. Boundary, quantized registers, and microscopic bridge/input derivations remain future sessions. |
...
- `qca_smv0` is a focused simulator sidecar for the next SM-QCA prototype; it currently implements the free BCC Weyl/Dirac bulk walk, static SM gauge-background transport, pure dynamic SM gauge fields, one-generation and three-family local Higgs/Yukawa collisions, finite-path FN recirculation, center-holonomy CP coefficients, dynamic classical Higgs-field evolution, Higgs gauge-current backreaction, local Yukawa fermion backreaction into Higgs momenta, family-summed BCC streaming currents, family-sourced SM gauge ticks, the full family production tick, a gauge-convention bridge audit, an exact antiunitary singlet bridge, physical-right bridged transport, the physical-right bridged fermion current, a physical-right sourced gauge tick, a physical-right production tick, sparse recorded rollout of that tick, a physical-right production Gauss monitor, a physical-right production energy monitor, a physical-right production variational audit, a physical-right production refinement limitation audit, and a physical-right production adjoint limitation audit, but should not be read as a boundary, quantized-register, microscopic bridge, Gauss-projection, exact full-energy conservation, timestep-refined energy convergence, full reversible-integrator, or flavor/Higgs-parameter derivation claim.
