...
| [`qca_smv0`](src/clifford_3plus2_d5/qca_smv0/) | **Infrastructure only** | Focused simulator sidecar for the next Standard-Model QCA prototype. Scaffolded with docs, scripts/tests folders, metadata, and a placeholder infrastructure test; no physics kernels or theory ledgers yet. |
...
- `qca_smv0` is a new focused simulator sidecar for the next SM-QCA prototype; it currently contains only infrastructure and should not be read as a physics claim.
