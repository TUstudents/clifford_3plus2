...
| [`qca_smv0`](src/clifford_3plus2_d5/qca_smv0/) | **Stage 1 PASS** | Focused simulator sidecar for the next Standard-Model QCA prototype. Stage 1 implements the free BCC Weyl/Dirac bulk walk in JAX with eight pull-convention hops, split-product Bloch symbols, exact hop-completeness checks, periodic norm conservation, Weyl continuum dispersion, anisotropy scaling, Dirac assembly from opposite chiral Weyl blocks, and JIT compatibility. Boundary, gauge, Higgs, SM carrier, and flavor recirculation remain future sessions. |
...
- `qca_smv0` is a focused simulator sidecar for the next SM-QCA prototype; it currently implements only the bare free BCC Weyl bulk walk and should not be read as a boundary, gauge, Higgs, or flavor claim.
