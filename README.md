...
choices as input. The `spacetime_qca` module builds a BCC-lattice simulation
sidecar around that internal carrier. These are different questions with
different answers, and the workspace is the honest superposition of them.
